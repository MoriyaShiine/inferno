...
public class InfernoWorldGeneration {
	...
	public static void bootstrapPlaced(BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, IRON_SHINING_OAK_TREE, featureLookup.getOrThrow(IRON_SHINING_OAK_TREE_CONFIGURED), PlacementUtils.filteredByBlockSurvival(InfernoBlocks.SHINING_OAK_SAPLING));
		PlacementUtils.register(context, GOLDEN_SHINING_OAK_TREE, featureLookup.getOrThrow(GOLDEN_SHINING_OAK_TREE_CONFIGURED), PlacementUtils.filteredByBlockSurvival(InfernoBlocks.SHINING_OAK_SAPLING));
	}
}
